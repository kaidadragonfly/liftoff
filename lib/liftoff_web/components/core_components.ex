defmodule LiftoffWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(LiftoffWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(LiftoffWeb.Gettext, "errors", msg, opts)
    end
  end
